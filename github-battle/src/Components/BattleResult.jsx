...
function BattleResult(props) {
  let user1 = props.data1;
  let user2 = props.data2,
    winner,
    loser;
  if (
  ...
  return (
    <main>
      <section className="result_section">
        <div className={props.darkMode ? "result_dark" : "result_light"}>
          ...
          <div className="result_col">
            ...
            <h2 className="inline-block mx-3">{winner.followers} followers</h2>
          </div>
          <div className="result_col">
            <img alt="" src="/images/rating.png" />
            <h2 className="inline-block mx-3">{winner.following} following</h2>
          </div>
          <div className="result_col">
